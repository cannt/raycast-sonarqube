...
const Form = Object.assign(
  ({ children, actions, ...props }) => (
    React.createElement("form", props, actions, children)
  ),
  {
    ...
    SubmitForm: ({ title, onSubmit }) => (
      React.createElement("button", { type: "submit", onClick: onSubmit }, title)
    ),
  }
);
const Action = Object.assign(
  ({ title, children, ...props }) => React.createElement("button", props, title, children),
...
const List = Object.assign(
  ({ children, actions, ...props }) => React.createElement("div", props, actions, children),
  {
